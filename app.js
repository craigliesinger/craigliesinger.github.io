...
myProjects.controller('ProjectsCtrl', ['$scope', function ($scope) {
  $scope.projects = [
    ...
    {'title': 'Math Espresso',
	 ...
	 'detail': "Wake up your brain with a shot of Math Espresso!  See how quickly you can correctly answer the 3 rounds of addition, subtraction, multiplication and division questions.  See how you stack up against others in the leader board and share your best times on Facebook and Twitter.  You can also hone your skills at your own pace, desired question type and difficulty in the Practice mode.",
